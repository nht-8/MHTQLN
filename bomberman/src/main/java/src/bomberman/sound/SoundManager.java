...
public class SoundManager {
    ...
    public static final String PLAYER_DEATH = "dead2"; // Hoặc dead2
    public static final String ENEMY_DEATH = "dead1"; // Hoặc dùng chung mob_dead nếu có
    ...
    public void loadSounds() {
        ...
        loadSoundEffect(PLAYER_DEATH, "/sounds/dead2.wav"); // Hoặc dead2.wav
        loadSoundEffect(ENEMY_DEATH, "/sounds/dead1.wav"); // Hoặc dead1.wav
