...
public class Ovapi extends Enemy {
    ...
    private void setSpriteBasedOnDirectionAndFrame() {
        ...
        // Ovapi chỉ có animation trái/phải.
    ...
    /**
     * Ghi đè die() để sử dụng animation chết cụ thể của Ovapi hoặc mob_dead chung.
     */
    @Override
    public void destroy() {
        if (isAlive() && !isDying()) { // Kiểm tra cả isDying từ Enemy
            // System.out.println("Ovapi is dying!");
