...
public class Minvo extends Enemy {
    ...
    private void setSpriteBasedOnDirectionAndFrame() {
        ...
        // Minvo chỉ có animation trái/phải.
        ...
        if (this.sprite == null) {
            ...
            if (this.sprite == null) {
                System.err.println("CRITICAL ERROR: Default Minvo sprite (enemy_ballom_left1) is also null!");
            }
        }
    }

    /**
     * Ghi đè die() để sử dụng animation chết cụ thể của Minvo hoặc mob_dead chung.
     */
    @Override
    public void destroy() {
        if (isAlive() && !isDying()) { // Kiểm tra cả isDying từ Enemy
            // System.out.println("Minvo is dying!");
